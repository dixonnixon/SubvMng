...
<<<TR
	<tr>
		...
		<td>{$out->getSum()}</td>
		<td>
			<a type="button" class="btn btn-info btn-sm" data-tooltip="tooltip" data-placement="right" title="нарахування" id="{$res["vars"]["name"]}List" href="index.php?CRUD=View&entity={$res["vars"]["name"]}&incId={$out->getId()}&month={$out->getMonth()}&type=Out">
